...
(function($) {
    ...
    $(document).ready( function() {
        ...
        if($('.project-showcase-carousel-active-scanner').length > 0) {
            $('.project-showcase-carousel-active-scanner').slick({
                infinite: false,
                slidesToShow: 4, 
                slidesToScroll: 2, 
                arrows: true,
                speed: 800,
                prevArrow: $('.project-carousel-nav-prev-scanner'),
                nextArrow: $('.project-carousel-nav-next-scanner'),
                responsive: [
                    {
                      breakpoint: 1600,
                      settings: {
        ...
        if($('.project-showcase-carousel-active-router').length > 0) {
          $('.project-showcase-carousel-active-router').slick({
              infinite: false,
              slidesToShow: 4, 
              slidesToScroll: 2, 
              arrows: true,
              speed: 800,
              prevArrow: $('.project-carousel-nav-prev-router'),
              nextArrow: $('.project-carousel-nav-next-router'),
              responsive: [
                  {
                    breakpoint: 1600,
                    settings: {
      ...
      if($('.project-showcase-carousel-active-laptop').length > 0) {
        $('.project-showcase-carousel-active-laptop').slick({
            infinite: false,
            slidesToShow: 4, 
            slidesToScroll: 2, 
            arrows: true,
            speed: 800,
            prevArrow: $('.project-carousel-nav-prev-laptop'),
            nextArrow: $('.project-carousel-nav-next-laptop'),
            responsive: [
                {
                  breakpoint: 1600,
                  settings: {
    ...
    if($('.project-showcase-carousel-active-tablet').length > 0) {
      $('.project-showcase-carousel-active-tablet').slick({
          infinite: false,
          slidesToShow: 4, 
          slidesToScroll: 2, 
          arrows: true,
          speed: 800,
          prevArrow: $('.project-carousel-nav-prev-tablet'),
          nextArrow: $('.project-carousel-nav-next-tablet'),
          responsive: [
              {
                breakpoint: 1600,
                settings: {
