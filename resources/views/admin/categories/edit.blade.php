                    ...
                    <form class="row g-3" method="POST" action="{{ route('admin.categories.update', $category->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-6">
                            ...
                            <select name="type" class="form-select">
                                ...
                                <option value="Home" {{ old('type', $category->type) == 'Home' ? 'selected' : '' }}>Home</option>
                        ...
                        <div class="col-6">
                            ...
                            <div class="mt-2">
                                @if($category->image)
                                    <img id="image-preview" src="{{ asset('public/storage/' . $category->image) }}" alt="Current Image" style="max-height: 100px;" />
                                @else
